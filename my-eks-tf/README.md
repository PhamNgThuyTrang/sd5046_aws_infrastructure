...
aws eks update-kubeconfig --region "us-west-2" --name "platformwale"
```
...
nginx   LoadBalancer   172.20.214.161   a90947031083b48b9b61849f22cdceda-410225407.us-west-2.elb.amazonaws.com   80:32414/TCP   2m59s
```
...
| <a name="input_k8s_version"></a> [k8s\_version](#input\_k8s\_version) | k8s version | `string` | `"1.31"` | no |
