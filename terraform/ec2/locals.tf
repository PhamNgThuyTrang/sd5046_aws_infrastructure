locals {
  bastion_hosts = {
    bastion_host_1 = {
        name = "bastion-host"
        ami                           = "ami-0e001c9271cf7f3b9"  # x86 Ubuntu for us-east-1
        ami-owner                     = "099720109477" // Canonical (Ubuntu owner)
        instance-type                 = "t3a.micro"  # ARM-based, $3/mo vs $7/mo (saves $4/mo)
        root-volume-size              = 10
        ...
        instance-count                = 1  // increase this value if you want to add more instances
